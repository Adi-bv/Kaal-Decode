class TenseModel:
    def __init__(self, tense_segments: list):
        ...
        if self.tense is None:
            self.find_tense(self.get_conditional_pattern())
    @staticmethod
    ...
    @staticmethod
    def get_conditional_pattern():
        return {
            'ConditionalPresentSimple': [{'would': ['MD']}, {'_': ['VB']}],
            'ConditionalPresentContinuous': [{'would': ['MD']}, {'be': ['VB']}, {'_': ['VBG']}],
            'ConditionalPresentPerfect': [{'would': ['MD']}, {'have': ['VB']}, {'_': ['VBN']}],
            'ConditionalPastSimple': [{'would': ['MD']}, {'_': ['VBD']}],
            'ConditionalPastContinuous': [{'would': ['MD']}, {'be': ['VB']}, {'_': ['VBG']}],
            'ConditionalPastPerfect': [{'would': ['MD']}, {'have': ['VB']}, {'_': ['VBN']}],
            'ConditionalFuture': [{'would': ['MD']}, {'_': ['VB']}],
        }
